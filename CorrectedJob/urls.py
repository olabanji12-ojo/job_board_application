"""
URL configuration for CorrectedJob project.
...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='base/reset.html'), name='password_reset_confirm'),
